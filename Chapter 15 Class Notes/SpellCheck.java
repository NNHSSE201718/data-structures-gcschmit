...
public class SpellCheck
{
    ...
    throws FileNotFoundException
    {
        ...
        /*
         * the enhanced for loop works with set
        ...
        System.out.println( "unqiue words: " + documentWords.size());
        
        /*
         * Print the number of unique words in the document with more than
         *      three letters.
         */
        
        /*
         * The Iterator class only supports three methods: hasNext, next, and remove
         */
        ...
        System.out.println( "unqiue words (> 3 letters): " + documentWords.size());
